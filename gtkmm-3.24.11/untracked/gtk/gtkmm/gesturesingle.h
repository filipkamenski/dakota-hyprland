 ...
 * events. set_touch_only() can be used to change the
 * touch behavior. Callers may also specify a different mouse button number
 * to interact with through set_button(), or react to any
 * mouse button by setting it to 0. While the gesture is active, the button being
 * currently pressed can be known through get_current_button().
 *
 * @newin{3,14}
 *
 * @ingroup Gestures
